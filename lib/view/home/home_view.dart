...
import 'package:study_side/view/notifications/notifications_view.dart';
import 'package:study_side/view/room/room_details_view.dart';
import 'package:study_side/view/room/study_rooms_view.dart';
...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ProgressViewModel>(
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          // Body — a white rounded-top sheet that overlaps the header
          Expanded(
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _StatCard(
                          emoji: '🔥',
                          iconBackground: const Color(0xFFFFEDE0),
                      ...
                      Expanded(
                        child: _StatCard(
                          ...
                          iconBackground: const Color(0xFFEDEFFB),
                          label: 'Focus Time',
                          value:
                              '${viewModel.formatTime(viewModel.weeklyFocusMinutes)} This Week',
                        ),
                      ),
                    ],
                  ),
